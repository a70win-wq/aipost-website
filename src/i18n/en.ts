...
const en = {
  global: {
    ...
    footer: {
      ...
      product: 'Product',
      productLinks: { pricing: 'Pricing', start: 'Get Started', manageSubscription: 'Manage subscription' },
      company: 'Company',
    ...
    pricing: {
      ...
      monthly: 'Monthly', annual: 'Annual', save: 'Pay 11 months, get 1 free', perMonth: '/mo', popularBadge: 'Most Popular', cta: 'Subscribe Now',
    },
